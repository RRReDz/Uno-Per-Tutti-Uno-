...
/**
 * Controller GRASP per l'UC "Autenticarsi". È un singleton, quindi l'unica
...
public class AutenticarsiController {
    ...
    public static AutenticarsiController getInstance() {
        if (singleInstance == null) {
            singleInstance = new AutenticarsiController();
        }
    ...
    /**
     * Inizializza il controller connettendolo al Web Server Simulato. Indirizzo
     * e porta sono definiti come variabili statiche di UnoXTutti
     *
    ...
    /**
     * @return l'oggetto Player che rappresenta il giocatore autenticato, null
     * se l'autenticazione non è ancora avvenuta o è fallita.
     */
