...
/**
 * I messaggi scambiati fra client e server sono di tipo P2PMessage. Ogni
 * P2PMessage ha un nome e dei parametri, rappresentati con un'array di Object.
 * Due messaggi particolari, Hello e Bye, possono essere creati tramite factory
 * methods. Hello viene usato nell'handshake iniziale di una connessione, mentre
 * Bye viene usato per chiudere la connessione stessa.
 *
 * @author picardi
 */
public class P2PMessage implements Serializable {
    ...
    /**
     * Stabilisce se il messaggio attuale è un messaggio Bye.
     *
    ...
    /**
     * Stabilisce se il messaggio attuale è un messaggio Hello.
     *
