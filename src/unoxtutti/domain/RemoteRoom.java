...
/**
 * Rappresenta una stanza dal punto di vista del client (per questa ragione "remote": perchè
 ...
 * notifiche di stato) per gestire l'ingresso del giocatore nella stanza remota da esso rappresentata.
 * @author picardi
 */
public class RemoteRoom extends Room implements MessageReceiver, DialogueObserver {
	 ...
	 * inizia il dialogo di tipo "RoomEntrance" necessario per completare l'ingresso
	 * nella stanza. Registra l'oggetto come Observer dove necessario (presso la connessione
	 * P2P per i messaggi "roomUpdate" e presso il DialogueHandler per notifiche 
	 * sull'evoluzione del dialogo).
	...
	/**
	 * @return fornisce un ListModel contenente i giocatori presenti nella stanza,
	...
	/** 
	 * 
	 * @return la P2P connection con cui questa RemoteRoom si collega
	 * alla corrispondente ServerRoom
	 */
	...
	/** Attua l'uscita del giocatore dalla stanza,
	 * notificando il server e chiudendo quindi la connessione.
	 */
	public void exit() {
