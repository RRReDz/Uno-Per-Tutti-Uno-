 ...
 * costituiscono il dialogo (in assenza di tale registrazione, non riceveranno
 * le notifiche e pertanto non potranno evolvere il proprio stato interno). Le
 * sottoclassi di DialogueHandler devono:
 * <ul>
 * <li>indicare una classe T che rappresenti le fasi, o stati, del dialogo. Le
 * istanze di T sono gli stati possibili.
 * <li>implementare il metodo evolveState che determina i passaggi di stato in
 * base ai messaggi ricevuti.
 * </ul>
 *
 * @author picardi
...
public abstract class DialogueHandler<T> implements MessageReceiver {
     ...
     * il DialogueHandler &egrave; nel suo stato iniziale.
     */
    ...
    /**
     * Registra un observer per essere notificato quando avviene un cambio di
     * stato.
     *
    ...
    /**
     * Rimuove un observer in modo che non venga pi&ugrave; notificato del
     * cambio di stato.
     *
     * @param obs
     */
     ...
     *
     * @param msg Il messaggio ricevuto.
     * @return true se &egrave; avvenuto un cambiamento di stato, false
     * altrimenti.
     */
